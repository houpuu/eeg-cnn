...
#dataFile = '.\data\shuzi\i_number_250.mat'
dataFile ='C:\PycharmProjects\eeg\data\music\EEG_music_sad0.mat'
...
train_input = np.reshape(scaled_train, (-1, 250, 16))
print('train_input的维度：', train_input.shape)
...
model = load_model('C:\PycharmProjects\eeg\model\music_250_model.h5')
...
layer_model1.add(Conv1D(200, 5, activation='relu', input_shape=(23, 200)))
layer_model1.add(MaxPooling1D(2))
layer_model1.add(Dropout(0.2))
layer_model1.add(GlobalAveragePooling1D())
layer_model1.add(Dense(10, activation='softmax'))
