...
dataFile = 'E:\PycharmProjects\eeg\data\EEG_music.mat'
...
model_m.add(Conv1D(40, 10, activation='relu'))
model_m.add(MaxPooling1D(2))
model_m.add(Conv1D(40, 10, activation='relu'))
model_m.add(MaxPooling1D(2))
...
##
### 评估模型,输出预测结果
score = model_m.evaluate(x_test, y_test, batch_size=50, verbose=1, sample_weight=None)
