...
dataFile = 'C:\EEG\music_feature\code_ver2\dSampleData_cnn.mat'
num_class = 5
...
model_m.add(MaxPooling1D(2))
model_m.add(Dropout(0.4))
model_m.add(Conv1D(100, 9, activation='relu'))
model_m.add(MaxPooling1D(2))
model_m.add(Dropout(0.2))
model_m.add(Conv1D(200, 9, activation='relu'))
model_m.add(MaxPooling1D(2))
model_m.add(Dropout(0.2))
...
#model_m.save('C:\PycharmProjects\EEG_CNN\model\music_400_new.h5')
